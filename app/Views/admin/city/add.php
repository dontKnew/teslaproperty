    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="<?= base_url().route_to("admin/city/add") ?>" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" class="form-control input-solid" aria-describedby="cityHelpBlock" required>
                                <small id="cityHelpBlock" class="form-text text-muted">
                                    Note : You can add more than one city name by comma separated.
                                </small>
                            </div>
